...
<div class="main--platform">
			...
			<div class="row">
				<div class="col-sm-5 lft-sec">
					...
					<div class="hero-btn">
						...
						<a href="<?php echo get_field("explore_button")["url"];?>" class="btn btn--outline-n btn--outline-n-w" target="_self"><span><?php echo get_field("explore_button")["title"];?></span></a>
					</div>
				</div>
	...
	<div class="platform-sec-2">
		<div class="wrap">
		    ...
		    <div class="sec-2-btns">
				...
				<a href="<?php echo get_field("explore_button_copy")["url"];?>" class="btn btn--outline-n btn--outline-n-b" ><span><?php echo get_field("explore_button_copy")["title"];?></span></a>
			</div>
		</div>
	</div>
	<!-- section 2 end -->
				...
				<div class="row">
					...
					<?php } ?>
						<div class="sec-2-btns">
							...
							<a href="<?php echo get_field("build_explore_button")["url"];?>" class="btn btn--outline-n btn--outline-n-b" target="_self"><span><?php echo get_field("build_explore_button")["title"];?></span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<?php } ?>
						<div class="sec-2-btns">
							...
							<a href="<?php echo get_field("optimize_explore_button")["url"];?>" class="btn btn--outline-n btn--outline-n-b" target="_self"><span><?php echo get_field("optimize_explore_button")["title"];?></span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-5 rgt-col">
						...
						<div class="sec-2-btns">
							...
							<a href="<?php echo get_field("deploy_explore_button")["url"];?>" class="btn btn--outline-n btn--outline-n-b" target="_self"><span><?php echo get_field("deploy_explore_button")["title"];?></span></a>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- section 6 end -->
<?php $resources_hide = get_field('resources_hide'); 
	if($resources_hide){
?>	

	<div class="resources platform-resources">
		<div class="resources-overlay desktop-visible">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/platform/blog-overlay.png">
		</div>
		<div class="resources-overlay mobile-visible">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/platform/mobile-blog-bg.svg">
		</div>
		<!-- /.resources -->
		<div class="wrap">
			<h2><?php echo get_field('resources_title'); ?></h2>

			<div class="resources__inner trig-owl-carousel owl-carousel">
				<?php if( have_rows('resources_pages') ){
					// Loop through rows.
					while( have_rows('resources_pages') ) { the_row(); ?>
				<a href="<?php echo get_sub_field("link")["url"];?>" class="resource">
					<div class="resource__image"><img width="1600" height="1099" src="<?php echo wp_get_attachment_url(get_sub_field('image')); ?>" class="attachment-full size-full" alt="" >
					</div>
					<!-- /.resource__image -->
					<div class="resource__content">
						...
						<span href="<?php echo get_sub_field("link")["url"];?>" class="link" target="_self"><?php echo get_sub_field("link")["title"];?> <span><span class="line"></span><!-- /.line --></span></span>
					</div>
					<!-- /.resource__content -->
				</a><!-- /.resource -->
				<?php } }?>
			</div><!-- /.resources__inner -->
...
<?php } ?>
	...
	<div class="bottom-section platform-bottom-section platform-bottom-section-video" >
			...
			<div class="wrap">
				<div class="content">
					...
					<div class="bottom-btns">
						...
						<a href="<?php echo get_field("learn_more")["url"];?>" class="btn btn--outline-n btn--outline-n-b"><span><?php echo get_field("learn_more")["title"];?></span></a>
					</div>
				</div><!-- /.content -->
			</div><!-- /.wrap -->
		</div>
...
<![endif]-->
<!-- <script charset="utf-8" type="text/javascript" src="<?php //echo get_field('enter_script_link_here'); ?>"></script> -->
<?php echo get_field('enter_script_link_here'); ?>

<!-- The Modal -->
<div id="myModal" class="modal beta-modal">
  <div class="modal-content">
    <span class="close" id="close">×</span>
    <div class="popup-content">
    	<div class="popup-title">
    		<h2><?php echo get_field('popup_heading'); ?></h2>
    	</div>
		<script>
		  <?php echo get_field('enter_script_code_here'); ?>
		</script>
    </div>
  </div>
