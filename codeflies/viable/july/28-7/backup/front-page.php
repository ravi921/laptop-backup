...
get_header(); ?>
    ...
    <!-- Hero start -->
    <section class="hero_section wow fadeInUp" data-wow-duration="3s">
      <div class="container">
        <div class="col-md-6">
    ...
    <!-- Tusted start -->
    <section class="trusted_section wow fadeInUp" data-wow-duration="3s">
      <div class="container">
        <div class="row">
          <div class="col-md-2">
    ...
    <!-- Services start -->
    <section class="services_section wow fadeInUp" data-wow-duration="3s">
      <div class="container">
      ...
      <div class="sec-lt-icon">
        <img src="/viable/wp-content/uploads/2021/07/service-2-ico.png">
      </div>
    </section>
    <!-- Services end -->

    <!-- project start-->
    <section class="project_section wow fadeInUp" data-wow-duration="3s">
      <div class="container">
      ...
      <div class="container-fluid">
        ...
        <div class="sec-lt-icon">
          <img src="/viable/wp-content/uploads/2021/07/change-3-ico.png">
        </div>
    </section>
    <!-- project End -->

    <!-- Client start -->
    <section class="client_section wow fadeInUp" data-wow-duration="3s">
      <div class="container">
    ...
    <section class="magnet_section wow fadeInUp" data-wow-duration="3s">
  	  <div class="container">
  	    <div class="row">
  	      <div class="col-md-6">
