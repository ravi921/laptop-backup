...
<!-- Hero start -->
<section class="hero_section inner-hero wow fadeInUp" data-wow-duration="3s">
  <div class="container">
      <div class="col-md-6">
...
<!-- Case 1 Start -->
<section id="waysec" class="case-who-sec wow fadeInUp" data-wow-duration="3s">
...
<!-- Case 2 Start -->
<section class="objective-sec wow fadeInUp" data-wow-duration="3s">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
...
<!-- Case 3 Start -->
<section class="challenges-sec wow fadeInUp" data-wow-duration="3s">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
...
<!-- Case 4 Start -->
<section class="case-services-sec wow fadeInUp" data-wow-duration="3s">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
...
<!-- Case 5 Start -->
<section class="results-sec wow fadeInUp" data-wow-duration="3s">
  <div class="container">
