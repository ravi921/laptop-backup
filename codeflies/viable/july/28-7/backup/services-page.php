...
get_header(); ?>
    ...
    <div id="services" class="service-sec wow fadeInUp" data-wow-duration="3s">
      <div class="">
        <div class="">
              ...
              <?php 
                  if( have_rows('services') ):
                      while( have_rows('services') ) : the_row();
                          ...
                          <a href="<?php the_field('service_link');?>" class="service-col">
                              ...
                              if( have_rows('sub_lists') ):?>
                                <ul>
                                  ...
                                  $child_title = get_sub_field('child_title'); ?>
                                   <li><?php the_sub_field('list_content');?></li>
                                  <?php endwhile; ?>
                                </ul>
                                  ...
                                  ?>
                               <span href="<?php echo $link_url; ?>" class="view-btn"><?php echo $link_title; ?></span>
                            </div>
